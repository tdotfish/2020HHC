...
# Note: This is how you would load and verify a blockchain contained in a file called blockchain.dat
    ...
    c2 = Chain(load=True, filename='myblock.dat')
    print('C2: Block chain verify: %s' % (c2.verify_chain(official_public_key)))
    #print(c2.blocks[1548])
    for blx in range(len(c2.blocks)):
      #if(c2.blocks[blx] == "58a3b9335a6ceb0234c12d35a0564c4e"):
      print(c2.blocks[blx])
      print("MD5:",c2.blocks[blx].full_hash())
      print("SHA256:", c2.blocks[blx].full_sha256_hash())
      #if (c2.blocks[blx].index == 129459):
          #print(c2.blocks[blx].full_hash())
          #c2.save_a_block(blx,"myblock.dat")
          #c2.blocks[blx].dump_doc(2)
      #print(c2.blocks[blx].index, ': ', c2.blocks[blx].full_sha256_hash())
      #print(f'{c2.blocks[blx].nonce:16b}')
      #print(int(bin(c2.blocks[blx].nonce),2))
      #c2.blocks[blx].dump_doc(1)